!function() {
        ...
        var n = "stub"
          ...
          , u = function t(n, a, r, o) {
                ...
                o ? Object.keys(u).forEach((function(n) {
                        "object" !== e(u[n]) || null === u[n] || u[n]instanceof HTMLElement ? i[n] = u[n] : ("object" !== e(i[n]) && (i[n] = c(u[n]) ? [] : {}),
                        i[n] = t(i[n], u[n], r, !0))
                }
                ...
                return function(e) {
                        ...
                        return function() {
                                ...
                                var r = n[0]
                                  ...
                                  , p = n[3]
                                  , l = void 0 === p ? s : p;
                                if (Number(l) === Number(s) && "string" == typeof r && "function" == typeof o)
                                        switch (r) {
                                        case "ping":
                                        ...
                                        "function" == typeof o && o(null, !1)
                        }
                }({
                        store: e,
                        cmpId: 123,
                        supportedAPIs: ["".concat(2, ":").concat(i), "".concat(7, ":").concat(s)]
                })
        };
        !function(t) {
                var n, a, r = "__gppLocator", o = window, i = o;
                var s = function() {
                ...
                o.addEventListener("message", (function(t) {
                        ...
                        r && window.__gpp(r.command, (function(e, a) {
                                var o = {
                                        __gppReturn: {
                                                returnValue: e,
                                                success: a,
                                ...
                                t && t.source && t.source.postMessage && t.source.postMessage(n ? JSON.stringify(o) : o, "*")
                        }
                ...
                var t = v(e)
                  , n = g(e);
                return function() {
                        var e, a, r, o, i = arguments.length >= 4 ? arguments.length <= 3 ? void 0 : arguments[3] : null;
                        return i = null !== (e = null !== (a = i) && void 0 !== a ? a : null === (r = window._iub) || void 0 === r || null === (o = r.csConfiguration) || void 0 === o ? void 0 : o.gppVersion) && void 0 !== e ? e : f(),
                        1 === Number(i) ? t.apply(void 0, arguments) : n.apply(void 0, arguments)
                }
        }
        ))
}();
